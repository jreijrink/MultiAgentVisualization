...
public class LinePlot implements Chart {
  ...
  public LinePlot(Scene scene, int[] selectedTurtles, String yParameter, int yParameterIndex, List<TimeFrame> data,  boolean liveUpdate) {
    this.scene = scene;
